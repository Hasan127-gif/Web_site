    ...
    <div className="pill-nav-container">
      <nav className={`pill-nav ${className}`} aria-label="Primary" style={cssVars}>
        ...
        <div className="logo-section">
          ...
          <span className="logo-text">BiEvim</span>
        </div>
        ...
        <div className="auth-section desktop-only">
          {isAuthenticated ? (
            <div className="auth-buttons">
              <Link to="/profile" className="auth-action pill">Profil</Link>
              <Link to="/logout" className="auth-action pill">Çıkış</Link>
            </div>
          ) : (
            <div className="auth-buttons">
              <Link to="/login" className="auth-action pill">Giriş Yap</Link>
              <Link to="/register" className="auth-action pill">Kayıt Ol</Link>
            </div>
          )}
        </div>
        ...
        <ul className="mobile-menu-list">
          ...
          {isAuthenticated ? (
            <>
              ...
              <li><Link to="/logout" className="mobile-menu-link">Çıkış</Link></li>
            </>
          ) : (
            <>
